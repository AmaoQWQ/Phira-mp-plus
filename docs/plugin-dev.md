...
```bash
wget https://github.com/AmaoQWQ/Phira-mp-plus/releases/latest/download/phira-plugin-sdk.tar.gz
...
全部 53 个函数的详细签名见 [WIT 定义文件](https://github.com/AmaoQWQ/Phira-mp-plus/blob/main/wit/phira-plugin.wit)。
...
完整 host API 列表见 [WIT 定义文件](https://github.com/AmaoQWQ/Phira-mp-plus/blob/main/wit/phira-plugin.wit)。
# WIT ABI 规范
